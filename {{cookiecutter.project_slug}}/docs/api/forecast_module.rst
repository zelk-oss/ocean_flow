...
:py:class:`~{{cookiecutter.project_slug}}.modules.forecast_module.ForecastModule` is an abstract
...
:py:class:`~{{cookiecutter.project_slug}}.modules.forecast_module.ForecastModule` and implement
...
.. seealso::
   ...
   :py:func:`~{{cookiecutter.project_slug}}.modules.utils.process_inputs`
