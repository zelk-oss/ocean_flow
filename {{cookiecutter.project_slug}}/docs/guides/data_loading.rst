...
This guide explains how the {{cookiecutter.project_name}} project loads data for
...
The :meth:`~{{cookiecutter.project_slug}}.data.data_module.TrainDataModule.setup` method creates separate
...
The :meth:`~{{cookiecutter.project_slug}}.data.data_module.TrainDataModule.train_dataloader` and
:func:`~{{cookiecutter.project_slug}}.data.data_module.TrainDataModule.val_dataloader` methods return
...
.. code-block:: python
    ...
    from {{cookiecutter.project_slug}}.data import TrainDataModule
...
- :doc:`/api/{{cookiecutter.project_slug}}.data` for the API reference of :class:`~{{cookiecutter.project_slug}}.data.dataset.TrainDataset`
  and :class:`~{{cookiecutter.project_slug}}.data.data_module.TrainDataModule`.
- :doc:`/api/{{cookiecutter.project_slug}}.pipelines` for details on how normalized tensors are produced from
  raw data.
