...
{{cookiecutter.project_name}} project. The example demonstrates conditional generative
...
extends :py:class:`~{{cookiecutter.project_slug}}.modules.train_module.TrainingModule` and implements
...
which extends :py:class:`~{{cookiecutter.project_slug}}.modules.forecast_module.ForecastModule`. The
