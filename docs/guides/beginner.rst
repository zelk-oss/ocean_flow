...
Ocean Flow Matching project. The example trains and runs a deterministic
...
standard :py:mod:`ocean_flow.modules` and :py:mod:`ocean_flow.pipelines` abstractions.
...
1. **Per-variable mean and standard deviation** (``states_mean``,
   ...
   used by :py:class:`~ocean_flow.pipelines.normalization.PreNormalization` for
...
2. **Per-variable standard deviation of 6-hour tendencies**
   ...
   :py:class:`~ocean_flow.pipelines.tendency.TendencyPrediction` to scale the
...
:py:class:`~ocean_flow.modules.train_module.TrainingModule` provides a shared
...
:py:func:`~ocean_flow.modules.utils.split_wd_params`.
...
class, which extends
:py:class:`~ocean_flow.modules.forecast_module.ForecastModule`.
...
:py:class:`~ocean_flow.modules.forecast_module.ForecastModule` already provides
...
- :doc:`/api/ocean_flow.modules` for the API reference of
  :py:class:`~ocean_flow.modules.train_module.TrainingModule` and
  :py:class:`~ocean_flow.modules.forecast_module.ForecastModule`.
